...
void AmpouleVue::majInterface(Modele::UnEtat e)
{
    switch (e) {
        case Modele::allume :
            ui->labelEtat->setPixmap(QPixmap("F:/BUT-Info/S2/R2-02-Developpement_d_applications_avec_IHM/TD5/images/ampouleAllumee2.PNG"));
            ui->bAllumer->setEnabled(false);
            ui->bEteindre->setEnabled(true);
            break;
        case Modele::eteint :
            ui->labelEtat->setPixmap(QPixmap("F:/BUT-Info/S2/R2-02-Developpement_d_applications_avec_IHM/TD5/images/ampouleEteinte2.PNG"));
