...
//But : fait monter une seule bulle

void triBulle(int tab[], unsigned int nbTab );
//But : réalise le tri complet d'un tableau tab de taille nbTab grâce à l'algorithme du tri à bulle et le sous-programme faireMonterLaBulleIci

//Tris
void triBulle(Personne tab[], unsigned int nbTab );
//But : réalise le tri complet d'un tableau tab de type personne de taille nbTab grâce à l'algorithme du tri à bulle et le sous-programme faireMonterLaBulleIci

void triBulle(Personne tab[], unsigned int nbTab );

void afficher(const Personne tab[],int nbTab);
//Affiche l'entièreté d'un tableau de tupe Personne
